        ...
        try {
		 ...
		 if(sId!=null){
			 ...
			 Connection con = DatabaseConnection.initializeDatabase();
				...
				PreparedStatement st = con.prepareStatement("select id,pass,name from Co-Host;");
		 ...
		 while(rs.next()){
			 if(sId.equals(rs.getString(1))){
			        ...
			        out.print("<div id='all'> <div class='cbox'> <h2 id='head-title'>Co-Host-Details</h2> <h3>User Name :</h3><br>"+rs.getString(3)+" </div>");
			        out.print("<div class='cbox'><font size=10 id='head'>WELCOME</font><br > <label for='c_name' class='labels' style='text-align: justify;'>SCHOOL name :</label> <select id='cities'></select></div>");
