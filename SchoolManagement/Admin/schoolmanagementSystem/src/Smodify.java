		...
		try { 
			 ...
			 HttpSession session=request.getSession(false);  
					 ...
					 if(name.equals(rss.getString(1)))
		        {
				 ...
				 String busno=request.getParameter("busNo");
				 PreparedStatement st = con.prepareStatement("select class,Expected_Class from z"+busno+" order by Expected_time;");
			 ...
			 else if(id.equals("showNo")){
				 //retrieve data from database and respond to

				 PreparedStatement st = con.prepareStatement("select teacherno from admin;");
				 ResultSet rs = st.executeQuery();
